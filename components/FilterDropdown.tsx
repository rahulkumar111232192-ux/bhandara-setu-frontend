...
export function FilterDropdown({ visible, filters, onFiltersChange, onClose }: FilterDropdownProps) {
  ...
  const handleStatusChange = (status: "live" | "ended" | "archived") => {
  ...
  return (
    <div 
      ref={dropdownRef}
      className="fixed left-20 top-1/2 z-[999] w-72 -translate-y-1/2 animate-scale-in rounded-2xl p-5 glass"
    >
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-col gap-2">
          {(["live", "ended", "archived"] as const).map((status) => (
